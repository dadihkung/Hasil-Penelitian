...
# 📥 Load data
df = pd.read_csv(r'C:\laragon\www\skripsi\EEG FEATURES\all_commands_features.csv')
...
joblib.dump(xgb_model, r'C:\laragon\www\skripsi\model_rf.joblib')
print("✅ XGBoost model saved as model_rf.joblib")

# 💾 Save the scaler
joblib.dump(scaler, r'C:\laragon\www\skripsi\scaler.joblib')
print("✅ Scaler saved as scaler.joblib")

# 💾 Save the label encoder
joblib.dump(label_encoder, r'C:\laragon\www\skripsi\label_encoder.joblib')
